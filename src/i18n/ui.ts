...
export const ui = {
  'zh-TW': {
    ...
    'warm.path.step1.tag': 'DONE',
    'warm.path.step1.title': '真實場域驗證',
    'warm.path.step1.body': '展期間數百位訪客互動，讓人告訴我們答案。',
    'warm.path.step2.tag': 'NOW',
    'warm.path.step2.title': '第一個 PILOT',
    'warm.path.step2.body': '尋找第一個品牌，一起用數據說話。',
    'warm.path.step3.tag': 'NEXT',
  ...
  en: {
    ...
    'warm.path.step1.tag': 'DONE',
    'warm.path.step1.title': 'Real-venue validation',
    'warm.path.step1.body': 'Hundreds of conversations on-site let people tell us the answer.',
    'warm.path.step2.tag': 'NOW',
    'warm.path.step2.title': 'First PILOT',
    'warm.path.step2.body': 'Looking for the first brand. Let data speak.',
    'warm.path.step3.tag': 'NEXT',
  ...
  ja: {
    ...
    'warm.path.step1.tag': 'DONE',
    'warm.path.step1.title': 'リアル現場検証',
    'warm.path.step1.body': '会期中、数百名の来場者と対話。現場が答えを教えてくれた。',
    'warm.path.step2.tag': 'NOW',
    'warm.path.step2.title': '最初のPILOT',
    'warm.path.step2.body': '最初のブランドを探しています。データで語る。',
    'warm.path.step3.tag': 'NEXT',
